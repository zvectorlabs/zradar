...
pub fn span_detail_to_proto(s: &SpanDetail) -> query_proto::SpanDetail {
    query_proto::SpanDetail {
        ...
        agent_description: s.agent_description.clone(),
        agent_task_id: s.agent_task_id.clone(),
        agent_task_parent_id: s.agent_task_parent_id.clone(),
        agent_task_name: s.agent_task_name.clone(),
        agent_task_kind: s.agent_task_kind.clone(),
        agent_task_state: s.agent_task_state.clone(),
        agent_task_status: s.agent_task_status.clone(),
        memory_type: s.memory_type.clone(),
        memory_key: s.memory_key.clone(),
        mcp_tool_name: s.mcp_tool_name.clone(),
        mcp_server_name: s.mcp_server_name.clone(),
        mcp_tool_input: s.mcp_tool_input.clone(),
