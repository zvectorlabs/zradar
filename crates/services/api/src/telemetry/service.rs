...
impl QueryService {
    ...
    pub async fn get_trace(
        ...
        let span_details: Vec<SpanDetail> = spans
            ...
            .map(|s| SpanDetail {
                ...
                agent_id: non_empty_string(s.agent_id.clone()),
                agent_description: non_empty_string(s.agent_description.clone()),
                agent_task_id: non_empty_string(s.agent_task_id.clone()),
                agent_task_parent_id: non_empty_string(s.agent_task_parent_id.clone()),
                agent_task_name: non_empty_string(s.agent_task_name.clone()),
                agent_task_kind: non_empty_string(s.agent_task_kind.clone()),
                agent_task_state: non_empty_string(s.agent_task_state.clone()),
                agent_task_status: non_empty_string(s.agent_task_status.clone()),
                memory_type: non_empty_string(s.memory_type.clone()),
                memory_key: non_empty_string(s.memory_key.clone()),
                mcp_tool_name: non_empty_string(s.mcp_tool_name.clone()),
                mcp_server_name: non_empty_string(s.mcp_server_name.clone()),
                mcp_tool_input: non_empty_string(s.mcp_tool_input.clone()),
                mcp_tool_output: non_empty_string(s.mcp_tool_output.clone()),
                agent_version: non_empty_string(s.agent_version.clone()),
                sdk_version: non_empty_string(s.sdk_version.clone()),
                evaluation_name: non_empty_string(s.evaluation_name.clone()),
                evaluation_explanation: non_empty_string(s.evaluation_explanation.clone()),
                evaluation_passed: (s.evaluation_passed != -1).then_some(s.evaluation_passed),
    ...
    pub async fn query_spans(
        ...
        let spans: Vec<SpanDetail> = result
            ...
            .map(|s| SpanDetail {
                ...
                agent_id: non_empty_string(s.agent_id),
                agent_description: non_empty_string(s.agent_description),
                agent_task_id: non_empty_string(s.agent_task_id),
                agent_task_parent_id: non_empty_string(s.agent_task_parent_id),
                agent_task_name: non_empty_string(s.agent_task_name),
                agent_task_kind: non_empty_string(s.agent_task_kind),
                agent_task_state: non_empty_string(s.agent_task_state),
                agent_task_status: non_empty_string(s.agent_task_status),
                memory_type: non_empty_string(s.memory_type),
                memory_key: non_empty_string(s.memory_key),
                mcp_tool_name: non_empty_string(s.mcp_tool_name),
                mcp_server_name: non_empty_string(s.mcp_server_name),
                mcp_tool_input: non_empty_string(s.mcp_tool_input),
                mcp_tool_output: non_empty_string(s.mcp_tool_output),
                agent_version: non_empty_string(s.agent_version),
                sdk_version: non_empty_string(s.sdk_version),
                evaluation_name: non_empty_string(s.evaluation_name),
                evaluation_explanation: non_empty_string(s.evaluation_explanation),
                evaluation_passed: (s.evaluation_passed != -1).then_some(s.evaluation_passed),
                model_parameters: parse_model_parameters(&s.model_parameters),
                events: parse_json_array(&s.events),
                links: parse_json_array(&s.links),
    ...
    pub async fn get_span(&self, workspace_id: WorkspaceId, span_id: &str) -> Result<SpanDetail> {
        ...
        Ok(SpanDetail {
            ...
            agent_id: non_empty_string(span.agent_id),
            agent_description: non_empty_string(span.agent_description),
            agent_task_id: non_empty_string(span.agent_task_id),
            agent_task_parent_id: non_empty_string(span.agent_task_parent_id),
            agent_task_name: non_empty_string(span.agent_task_name),
            agent_task_kind: non_empty_string(span.agent_task_kind),
            agent_task_state: non_empty_string(span.agent_task_state),
            agent_task_status: non_empty_string(span.agent_task_status),
            memory_type: non_empty_string(span.memory_type),
            memory_key: non_empty_string(span.memory_key),
            mcp_tool_name: non_empty_string(span.mcp_tool_name),
            mcp_server_name: non_empty_string(span.mcp_server_name),
            mcp_tool_input: non_empty_string(span.mcp_tool_input),
            mcp_tool_output: non_empty_string(span.mcp_tool_output),
            agent_version: non_empty_string(span.agent_version),
            sdk_version: non_empty_string(span.sdk_version),
            evaluation_name: non_empty_string(span.evaluation_name),
            evaluation_explanation: non_empty_string(span.evaluation_explanation),
            evaluation_passed: (span.evaluation_passed != -1).then_some(span.evaluation_passed),
